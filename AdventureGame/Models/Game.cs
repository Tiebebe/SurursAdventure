        ...
        public static void FightWithSword()
        {
            ...
            do
            {
                ...
                switch (PlayersChoice)
                {
                    case "a":
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        Console.WriteLine($"you have just attack the monster with a sword which deals {swordAmountOfDamage} amount of damage ");
                        Random r = new Random();
        ...
        public static void FightWithAxe()
        {
            ...
            do
            {
                ...
                switch (PlayersChoice)
                {
                    case "a":
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        Console.WriteLine($"you have just attack the monster with an exe which deals {axeAmountOfDamage} amount of damage ");
                        Random r = new Random();
        ...
        public static void FightWithMace()
        {
            ...
            do
            {
                ...
                switch (PlayersChoice)
                {
                    case "a":
                        Console.ForegroundColor = ConsoleColor.Cyan;
                        Console.WriteLine($"you have just attack the monster with Mace which deals {maceAmountOfDamage} amount of damage ");
                        Random r = new Random();
            ...
            do
            {
                ...
                switch (PlayersChoice)
                {
                    case "a":
                        ...
                        Random r = new Random();
                        p.AmountOfDamage = AxeAmountOfDamage + r.Next(1, 7);
                        lMonster.Health -= p.AmountOfDamage;
                        Console.WriteLine($"The monster has  now a health level of  {lMonster.Health}");
                        Random rand = new Random();
                        int monsterDamage = amountOfDamage + rand.Next(8, 12);
                        p.Health -= monsterDamage;
                        p.TotalPlayerGold += lMonster.Loot;
                        Console.WriteLine($"the monster fights back! you have now a\nhealth level of {p.Health}\nTotal amount of gold:{p.TotalPlayerGold}");
                        System.Threading.Thread.Sleep(700);
